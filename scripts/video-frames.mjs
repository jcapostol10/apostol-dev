...
const videoPath = path.join(projectRoot, "VID_20260502_112751.mp4");
const tmpHtml = path.join(projectRoot, "_vidplay.html");
writeFileSync(
  tmpHtml,
  `<!doctype html><html><body style="margin:0;background:#000">
<video id="v" src="VID_20260502_112751.mp4" muted preload="auto"></video>
<script>
...
for (let i = 0; i < n; i++) {
  ...
  await page.locator("video").screenshot({ path: `scripts/screens/vid-${i}.png` });
  console.log("frame", i, "@", t.toFixed(2));
}
await browser.close();
console.log("ok");
